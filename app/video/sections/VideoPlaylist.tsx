  ...
  return (
    <div className="flex flex-col lg:flex-row bg-white dark:bg-black text-black dark:text-white rounded-xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-700">
      ...
      <div className="w-full lg:w-2/3 p-4">
        ...
        <h2 className="text-2xl font-bold mb-2">{video.prompt}</h2>

        {/* Fake Controls Row (likes, shares, etc.) */}
      ...
      {/* Sidebar Thumbnails Section (static preview slots) */}
      <div className="w-full lg:w-1/3 border-t lg:border-t-0 lg:border-l border-gray-200 dark:border-gray-700 p-4 space-y-4 max-h-[600px] overflow-y-auto">
        {[...Array(1)].map((_, idx) => (
          <div
            key={idx}
            className="flex gap-2 items-start hover:bg-gray-100 dark:hover:bg-gray-800 p-2 rounded transition"
          >
            <div className="w-24 h-14 bg-gray-200 dark:bg-gray-700 rounded overflow-hidden">
              <img
